...
/*
@note This file is the reason I created the fork. 
It's unclear to me whether you need the redhat extension or not. The readme says
it's incompatible, and the source code itself says it's required... however I
don't use that plugin and the completions work fine without it.
*/
